[![header](../assets/header04.jpg)](https://yuenshome.github.io)
...
- [primer-ppt] [class4_class_and_object_construct_func.pdf：重点是引用计数、写时拷贝（MyString类中实现）](./cpp/primer-ppt/class4_class_and_object.pdf)
